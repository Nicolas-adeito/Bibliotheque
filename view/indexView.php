  ...
  <tbody>
    ...
    <tr>
      ...
      <?php if($sortBook->getUser_id() !== NULL): ?>
        <td><span class="badge badge-danger">Disponible</span></td>
      <?php else: ?>
        <td><span class="badge badge-success">Not disponible</span></td>
      <?php endif; ?>
  ...
  <tbody>
    ...
    <tr>
      ...
      <?php if($book->getUser_id() !== NULL): ?>
        <td><span class="badge badge-danger">Disponible</span></td>
      <?php else: ?>
        <td><span class="badge badge-success">Non disponible</span></td>
      <?php endif; ?>
